...
var htmlContent = '<!DOCTYPE html><html lang="id"><head><meta charset="UTF-8">' +
  ...
  '<style>' +
    ...
    /* Border & aksen utama menggunakan warna Hijau Muda Daun Segar (#5BBD61) */
    '.header{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:32px;padding-bottom:20px;border-bottom:3px solid #5BBD61}' +
    '.brand-col h1{margin:0 0 4px;font-size:24px;color:#5BBD61;letter-spacing:.02em}' +
    '.brand-col p{margin:2px 0;font-size:11px;color:#666}' +
    '.inv-meta{text-align:right}' +
    '.inv-meta .inv-num{font-size:18px;font-weight:700;color:#5BBD61;margin-bottom:4px}' +
    '.inv-meta p{margin:2px 0;font-size:11px;color:#666}' +
    '.section-title{font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.1em;color:#5BBD61;margin:22px 0 8px}' +
    /* Background info box disesuaikan dengan tone hijau daun muda super soft (#F1F8F1) */
    '.info-box{background:#F1F8F1;border:1px solid #C8E6C9;border-radius:8px;padding:14px 18px}' +
    ...
    /* Box paket utama dengan warna Hijau Muda Daun (#5BBD61) */
    '.paket-box{background:#5BBD61;color:#fff;border-radius:8px;padding:16px 18px;margin:12px 0}' +
    '.paket-box .paket-name{font-size:16px;font-weight:700;margin-bottom:4px}' +
    /* Box syarat & ketentuan */
    '.syarat-box{background:#F9FDF9;border:1px solid #DCEDC8;border-radius:8px;padding:14px 18px;line-height:1.7;font-size:12px;color:#444}' +
    /* Box transfer disesuaikan ke nuansa soft mint/green (#E8F5E9) */
    '.transfer-box{display:flex;align-items:center;gap:16px;background:#E8F5E9;border:1px solid #A5D6A7;border-radius:8px;padding:14px 18px}' +
    ...
    '.transfer-value{font-size:15px;font-weight:700;color:#2E7D32;letter-spacing:.04em}' +
    '.footer{margin-top:40px;padding-top:16px;border-top:1px solid #C8E6C9;display:flex;justify-content:space-between;font-size:11px;color:#888}' +
